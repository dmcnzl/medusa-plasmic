...
import sty from "./PlasmicCartItem.module.css"; // plasmic-import: aUSbAc7kaBAg/css

import RecycleIcon from "./icons/PlasmicIcon__Recycle"; // plasmic-import: oaRxLqhgeBMH/icon
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___83RTv)}
      >
        <PlasmicLink__
          ...
          platform={"nextjs"}
        >
          <div className={classNames(projectcss.all, sty.freeBox___6WkEt)}>
            <div
              className={classNames(
                projectcss.all,
        ...
        {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
          ...
          return (
            <div
              className={classNames(projectcss.all, sty.freeBox__y27So)}
              key={currentIndex}
            >
              <div
                className={classNames(
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__jQpam)}
        >
          <RecycleIcon
            className={classNames(projectcss.all, sty.svg__lOqFc)}
            role={"img"}
          />

          <Secure2Icon
            className={classNames(projectcss.all, sty.svg__eDdU)}
            role={"img"}
          />
        </Stack__>
        <div className={classNames(projectcss.all, sty.freeBox___7FEll)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
