...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: k2MIItv61a0P/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: wzGNy0KErEd0/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__ojBHg)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__ra2Ij)}
              />
            </React.Fragment>
          ),
