...
import sty from "./PlasmicButton.module.css"; // plasmic-import: khrEFwnXt76p/css
  ...
  return (
    <Stack__
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootshowEndIcon_colors_black_rounded_size_large]:
            hasVariant($state, "showEndIcon", "showEndIcon") &&
            hasVariant($state, "colors", "black") &&
            hasVariant($state, "size", "large") &&
            hasVariant($state, "rounded", "rounded"),
    ...
    >
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__aYJm, {
            [sty.freeBoxiconOnly__aYJmAjxAe]: hasVariant(
              $state,
              "iconOnly",
              "iconOnly"
            ),
            [sty.freeBoxshowEndIcon__aYJm09Q1X]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),
            [sty.freeBoxshowStartIcon__aYJmkmNrW]: hasVariant(
              $state,
              "showStartIcon",
              "showStartIcon"
            ),
            [sty.freeBoxsize_large__aYJMsdwTn]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__aYJmaj545]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <MenuIcon
                className={classNames(projectcss.all, sty.svg__osNsH)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__zXLpN, {
            [sty.freeBoxshowEndIcon__zXLpN09Q1X]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),
            [sty.freeBoxsize_small__zXLpNaj545]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false)
            ? renderPlasmicSlot({
                defaultContents: (
                  <MenuIcon
                    className={classNames(projectcss.all, sty.svg__jkQdd)}
                    role={"img"}
                  />
                ),
