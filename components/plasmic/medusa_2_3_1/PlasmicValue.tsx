...
import sty from "./PlasmicValue.module.css"; // plasmic-import: 5DSDxhDBXnn2/css

import TakeOffIcon from "./icons/PlasmicIcon__TakeOff"; // plasmic-import: AZSF9muffcQj/icon
...
function PlasmicValue__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__blsx9, {
          [sty.freeBoxcenter__blsx91YsiA]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxtopBottom__blsx9BVgS9]: hasVariant(
            $state,
            "topBottom",
            "topBottom"
          )
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__vrppj)}>
          {renderPlasmicSlot({
            defaultContents: (
              <TakeOffIcon
                className={classNames(projectcss.all, sty.svg___83Jj3)}
                role={"img"}
              />
            ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__mcFmj, {
          [sty.freeBoxcenter__mcFmj1YsiA]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxwithButton__mcFmj0XGo]: hasVariant(
            $state,
            "withButton",
            "withButton"
          )
      ...
      {(hasVariant($state, "withButton", "withButton") ? true : false) ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__fajso, {
            [sty.freeBoxcenter__fajso1YsiA]: hasVariant(
              $state,
              "center",
              "center"
            ),
            [sty.freeBoxwithButton__fajso0XGo]: hasVariant(
              $state,
              "withButton",
              "withButton"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Button
                className={classNames("__wab_instance", sty.button__tewyX, {
                  [sty.buttonwithButton__tewyX0XGo]: hasVariant(
                    $state,
                    "withButton",
                    "withButton"
                  )
                ...
                endIcon={
                  <RightArrowIcon
                    className={classNames(projectcss.all, sty.svg__tfuD)}
                    role={"img"}
                  />
                }
                rounded={true}
