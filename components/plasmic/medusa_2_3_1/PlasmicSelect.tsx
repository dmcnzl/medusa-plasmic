...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: OsPTIIsvQdG2/component
import Select__Option from "../../Select__Option"; // plasmic-import: JkUcSlHfebWj/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: k2MIItv61a0P/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: wzGNy0KErEd0/css

import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: Ji38XmP7GXlb/icon
import ChevronUpSvgIcon from "./icons/PlasmicIcon__ChevronUpSvg"; // plasmic-import: Fiha58ad4_D2/icon
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__aGs3)}
                      value={"value1"}
                    >
                      {"Option 1"}
                    </Select__Option>
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__gAp0)}
                      value={"value2"}
                    >
                      {"Option 2"}
                    </Select__Option>
