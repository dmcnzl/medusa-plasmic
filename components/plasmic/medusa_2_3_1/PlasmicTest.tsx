...
import sty from "./PlasmicTest.module.css"; // plasmic-import: Hrg1Z2K9sDmn/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <DataCtxReader__>
              {$ctx => (
                <div className={classNames(projectcss.all, sty.freeBox__gq9IF)}>
                  <ProductTextField
                    className={classNames(
                      "__wab_instance",
                      sty.productTextField__vSjF0
                    )}
                    field={"title"}
                  />
          ...
          >
            <DataCtxReader__>
              {$ctx => (
                <div className={classNames(projectcss.all, sty.freeBox__ujejj)}>
                  <ProductTextField
                    className={classNames(
                      "__wab_instance",
                      sty.productTextField___7YpHm
                    )}
                    field={"title"}
                  />
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__qCwd)}
                  >
                    {(_par =>
