...
import sty from "./PlasmicCopyrightSocialLanguage.module.css"; // plasmic-import: 6bVtRBteySmh/css

import TwitterIcon from "./icons/PlasmicIcon__Twitter"; // plasmic-import: _sqcCzHioLUi/icon
import MenuIcon from "./icons/PlasmicIcon__Menu"; // plasmic-import: zs7Aa1MdV4FH/icon
import YoutubeIcon from "./icons/PlasmicIcon__Youtube"; // plasmic-import: kLOVjmR0hdG1/icon
import PintrestIcon from "./icons/PlasmicIcon__Pintrest"; // plasmic-import: NSJhfxCmNng1/icon
import Icon15Icon from "./icons/PlasmicIcon__Icon15"; // plasmic-import: ofTyDUZGF0Zh/icon
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__t37Dy)}
      >
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___3SJgx)}
        >
          <div
          ...
          <div className={classNames(projectcss.all, sty.freeBox__oKr3)}>
            <Button
              iconOnly={true}
              link={"http://twitter.com"}
              startIcon={
                <TwitterIcon
                  className={classNames(projectcss.all, sty.svg__oAfyi)}
                  role={"img"}
                />
              }
              submitsForm={true}
            ...
            <Button
              className={classNames("__wab_instance", sty.button__vz4El)}
              iconOnly={true}
              link={"http://youtube.com"}
              startIcon={
                <YoutubeIcon
                  className={classNames(projectcss.all, sty.svg__cLGc)}
                  role={"img"}
                />
              }
              submitsForm={true}
            ...
            <Button
              className={classNames("__wab_instance", sty.button__jayMl)}
              iconOnly={true}
              link={"http://pinterest.com"}
              startIcon={
                <PintrestIcon
                  className={classNames(projectcss.all, sty.svg__oWiQ6)}
                  role={"img"}
                />
              }
              submitsForm={true}
        ...
        <Button
          className={classNames("__wab_instance", sty.button__o3S79)}
          endIcon={
            <Icon15Icon
              className={classNames(projectcss.all, sty.svg___4Ot1V)}
              role={"img"}
            />
          }
          showEndIcon={true}
          startIcon={
            <Icon15Icon
              className={classNames(projectcss.all, sty.svg__iynHw)}
              role={"img"}
            />
          }
          submitsForm={true}
