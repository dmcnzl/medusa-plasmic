...
import sty from "./PlasmicProductCard.module.css"; // plasmic-import: -VhJ5zkOF9d9/css
    ...
    >
      ...
      >
        ...
        {(
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__mombg, {
              [sty.freeBoxsmall__mombGxyre6]: hasVariant(
                $state,
                "small",
                "small"
              )
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__uvoAk, {
            [sty.freeBoxsmall__uvoAKxyre6]: hasVariant($state, "small", "small")
          })}
        >
          <div className={classNames(projectcss.all, sty.freeBox__sSuvH)}>
            {renderPlasmicSlot({
              defaultContents: (
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Rating
                  className={classNames("__wab_instance", sty.rating__hfr4Q)}
                />
              ),
          ...
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__sxeHg)}
          >
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
          ...
          <div className={classNames(projectcss.all, sty.freeBox__tfJaE)}>
            {(() => {
              try {
